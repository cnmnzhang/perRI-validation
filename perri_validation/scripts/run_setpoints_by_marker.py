...
pipeline markers -- see perri_validation/README.md. Reads its markers from the per-marker
...
Run:
    python -m perri_validation.scripts.run_setpoints_by_marker --input-dir perri_validation/data --output-dir perri_validation/outputs/setpoints_by_marker
"""
...
from perri_validation.constants.marker_config import TESTCODES_LIST  # noqa: E402
from perri_validation.constants.runtime import DEFAULT_MIN_MEASUREMENTS, ID_COL  # noqa: E402
