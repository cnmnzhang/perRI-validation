...
Two marker-outcome pairs (perri_validation/utils/clinical/pregnancy.py:PAIR_SPECS):
...
gestational_age, rbc_tf, pih) -- see perri_validation/README.md. Setpoints are
...
Run:
    python -m perri_validation.scripts.run_fig4_pregnancy --input-dir perri_validation/data --output-dir perri_validation/outputs/fig4_pregnancy
"""
...
from perri_validation.utils.io import load_pregnancy_labs_csv, load_pregnancy_outcomes_and_demogs_csv  # noqa: E402
from perri_validation.utils.logging_utils import tagged_stdout, timed_step  # noqa: E402
from perri_validation.utils.clinical.pregnancy import PAIR_SPECS, compute_inpreg_analysis_df, compute_prepreg_setpoint_table, select_trimester_midpoints, task1_setpoint_distribution, task1_summary_df, task2_results_df, task3_payload
from perri_validation.constants.fig_config import A4_WIDTH, FIG4_ROW1_HEIGHT
from perri_validation.utils.visuals_fig4_pregnancy import plot_task1_on_ax, plot_task2_on_ax, plot_task3_on_ax
from perri_validation.utils.visuals_shared import add_panel_label, save_fig_as_svg
