...
route/formulation (IV, iron sucrose) — see perri_validation/README.md.
...
perri_validation/utils/clinical/run_clinical.py.
...
Run:
    python -m perri_validation.scripts.run_fig5_iron_infusion --input-dir perri_validation/data --output-dir perri_validation/outputs/fig5_iron_infusion
"""
...
from perri_validation.utils.io import load_iron_mar_csv, load_tests_marker_subset  # noqa: E402
...
from perri_validation.utils.setpoints import compute_sp_df, is_fitted, is_fitted_canonical  # noqa: E402
from perri_validation.utils.clinical.inputs import IronInfusionConfig  # noqa: E402
...
from perri_validation.constants.fig_config import (  # noqa: E402
    A4_WIDTH,
    FIG5_COL1_WIDTH,
    FIG5_COL2_WIDTH,
    FIG5_COL3_WIDTH,
...
from perri_validation.constants.runtime import ID_COL, MU, TS_COL  # noqa: E402
from perri_validation.utils.visuals_fig5 import (  # noqa: E402
