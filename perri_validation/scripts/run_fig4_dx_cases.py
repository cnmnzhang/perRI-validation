...
heatmap), using perri_validation/utils/visuals_fig4.py's rendering functions
...
— see perri_validation/README.md. Run dx_incident first: `python -m perri_validation.scripts.run_dx_incident`.
...
Run:
    python -m perri_validation.scripts.run_fig4_dx_cases --input-dir perri_validation/data --output-dir perri_validation/outputs/fig4_dx_cases
"""
...
from perri_validation.utils.io import load_demographics_csv, load_dx_incident, load_tests_marker_subset  # noqa: E402
from perri_validation.utils.logging_utils import tagged_stdout  # noqa: E402
from perri_validation.utils.visuals_shared import save_fig_as_svg  # noqa: E402
from perri_validation.utils.setpoints import compute_sp_df, is_fitted_canonical  # noqa: E402
from perri_validation.utils.cache import cache_or_compute  # noqa: E402
from perri_validation.utils.clinical.get import attach_ref_intervals  # noqa: E402
from perri_validation.constants.fig_config import A4_WIDTH, FIG4_ROW1_HEIGHT  # noqa: E402
from perri_validation.utils.km_exclusive import KMExclusiveInputs  # noqa: E402
from perri_validation.utils.progression.config import OUTCOME_REGISTRY  # noqa: E402
from perri_validation.utils.progression.core import (  # noqa: E402
    compute_popri_continuous,
    load_or_create_analysis_ready_cohort,
)
from perri_validation.utils.progression.logit import fit_logit_and_report  # noqa: E402
from perri_validation.constants.runtime import (  # noqa: E402
    CV_COL,
    DELTA_COL,
    ID_COL,
    MU,
...
from perri_validation.utils.clinical.inputs import ProgressionPanelInputs  # noqa: E402
from perri_validation.utils.clinical.run_clinical import build_added_value_tables, build_reclassification_2x2_grids  # noqa: E402
from perri_validation.utils.visuals_fig4 import (  # noqa: E402
    fig4forest_on_ax,
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--dx-incident-path", type=Path, default=None, help="Path to dx_incident.csv from `perri_validation.scripts.run_dx_incident`. Default: perri_validation/outputs/dx_incident/dx_incident.csv")
