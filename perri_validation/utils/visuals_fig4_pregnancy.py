"""Pregnancy panel plotting (Task 1/2/3).
...
from perri_validation.utils.clinical.pregnancy import PairSpec, PREDICTOR_LABELS, TRIMESTER_LABELS
from perri_validation.constants.fig_config import FIG4_HEATMAP_ANNOT_FONTSIZE, FIG4_LEGEND_FONTSIZE, FIG4_TITLE_FONTSIZE, MODEL2COLOR, QUANTILE_BAND_INNER_ALPHA, QUANTILE_BAND_OUTER_ALPHA, REF_LINE_STYLE
from perri_validation.constants.marker_config import TESTCODE_DISPLAY
from perri_validation.constants.runtime import DELTA_COL, MEASUREMENT_COL
