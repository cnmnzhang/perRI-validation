"""Dispatcher: run one or all perri_validation/ analyses.
...
from perri_validation.scripts import run_dx_incident, run_fig3_dx, run_fig3_hazard, run_fig4_dx_cases, run_fig4_pregnancy, run_fig5_iron_infusion, run_setpoints_by_marker, run_tests_by_marker  # noqa: E402
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Run perri_validation/ analyses end to end.")
