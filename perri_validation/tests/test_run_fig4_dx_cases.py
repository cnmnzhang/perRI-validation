"""Tests for perri_validation/scripts/run_fig4_dx_cases.py's cache layering.
...
import perri_validation.scripts.run_fig4_dx_cases as m
import perri_validation.utils.setpoints as setpoints_module
from perri_validation.constants.runtime import ID_COL, MEASUREMENT_COL, PERRI_Z_SCORE_COL, SEX_COL, TEST_CODE_COL, TS_COL
