"""Tests for perri_validation/constants/schemas.py + utils/io.py.
...
from perri_validation.utils.io import load_demographics_csv, load_dx_csv, load_iron_mar_csv, load_tests_csv, load_tests_marker_subset, resolve_tests_csv_path
from perri_validation.constants.schemas import ALL_SCHEMAS, DEMOGRAPHICS_SCHEMA, DX_SCHEMA, IRON_MAR_SCHEMA, TESTS_SCHEMA
