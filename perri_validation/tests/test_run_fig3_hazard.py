"""Tests for perri_validation/scripts/run_fig3_hazard.py's plot-data-first caching.
...
import perri_validation.scripts.run_fig3_hazard as m
import perri_validation.utils.setpoints as setpoints_module
from perri_validation.scripts.run_fig3_hazard import run
