"""Tests for perri_validation/utils/cache.py: cache_or_compute + hash_dataframe.
...
always roots at the real perri_validation/data/cache/) -- tests must never touch
...
from perri_validation.utils.cache import cache_or_compute, hash_dataframe
