"""Tests for perri_validation/scripts/run_setpoints_by_marker.py.
...
from perri_validation.scripts.run_setpoints_by_marker import run
from perri_validation.scripts.run_tests_by_marker import build_tests_by_marker
from perri_validation.utils.setpoints import is_fitted_canonical
...
def test_run_fits_requested_markers_and_warms_shared_cache(tmp_path, monkeypatch):
    import perri_validation.scripts.run_setpoints_by_marker as m
