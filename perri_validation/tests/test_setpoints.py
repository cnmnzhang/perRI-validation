"""Tests for perri_validation/utils/setpoints.py:compute_sp_df.

Every test monkeypatches CACHE_DIR to tmp_path -- these must never touch the
real, shared perri_validation/data/cache/.
"""
...
from perri_validation.constants.runtime import DEFAULT_MIN_MEASUREMENTS
from perri_validation.scripts.run_tests_by_marker import build_tests_by_marker
from perri_validation.utils.setpoints import SP_DF_COLUMNS, _compute_popri_patch, _grid_bounds_from_pop_ri, _params_override, compute_sp_df, fit_markers, fit_markers_lazy, is_fitted, is_fitted_canonical
