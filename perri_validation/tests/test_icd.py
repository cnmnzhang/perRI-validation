"""Tests for perri_validation/utils/clinical/icd.py's dx_all_to_first_fast.
...
from perri_validation.utils.clinical.icd import dx_all_to_first_fast
from perri_validation.constants.icd_config import DX2ICD
from perri_validation.utils.io import load_dx_csv
