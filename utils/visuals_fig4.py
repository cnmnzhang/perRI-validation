...
The four functions for fig4_dx_cases mosaic:
...
from utils.clinical.inputs import ProgressionPanelInputs
from utils.clinical.run_clinical import build_added_value_tables, build_reclassification_2x2_grids
from utils.clinical import get as _get
from constants.fig_config import (
...
from utils.km_exclusive import KMExclusiveInputs
from utils.visuals_shared import PROG_STYLING, year_since_baseline
