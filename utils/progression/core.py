...
utils/progression/config.py need:
...
from utils.clinical.inputs import OutcomeConfig
from utils.clinical.run_clinical import add_oo
from constants.runtime import ID_COL, MEASUREMENT_COL, MU, PRESENT_TS_COL, PRESENT_VAL_COL, SIGMA, TEST_CODE_COL, TS_COL
